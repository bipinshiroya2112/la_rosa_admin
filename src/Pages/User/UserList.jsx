              ...
              sliceData?.map((d, index) => (
                ...
                >
                  ...
                  <div className="w-[20%] flex flex-row justify-center md:justify-start items-center gap-2">
                    ...
                    /> */}
                    <button
                      className={`flex justify-center items-center gap-2 text-white font-medium text-xs md:text-sm rounded-3xl shadow-md hover:shadow-lg py-3 px-5 cursor-pointer ${
                        d.isActive ? "bg-green-500" : "bg-[#E5002A]"
                      }`}
                      onClick={() => {
                        setDeleteConfirmation(true);
                        setSelectedUser(d);
          ...
          {UsersInfo.length > 10 ? (
            <div className="flex gap-2 pb-5 bottom-0">
              ...
              {numbers.map((item, index) => (
                <button
                  disabled={item === "..."}
                  className={`py-[3px] px-3 bg-red-200 rounded-full ${
                    currentPage === item &&
